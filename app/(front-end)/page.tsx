        ...
        <div className='text-center '>
          <h1 className='text-4xl font-extrabold tracking-tight text-gray-900 dark:text-slate-200 sm:text-5xl md:text-6xl'>
            <span className='block xl:inline'>
              <span className='mb-1 block'>We got you!</span>
            ...
            <div className='mt-2'>
              your Links{" "}
              <span className='hidden lg:inline-flex'> 10x faster&nbsp; </span>
              in&nbsp;
              <span className='relative mt-3 whitespace-nowrap text-blue-600'>
                ...
                <span className='before:block before:absolute before:-inset-1 before:-skew-y-3 before:bg-pink-500 relative inline-block'>
                  <span className='relative text-white'>minutes</span>
                </span>
              </span>
            </div>
          </h1>
          ...
          <div className='mt-5 sm:mt-8 sm:flex sm:justify-center'>
            <div className='rounded-md shadow'>
              <Link
                className='flex w-full items-center justify-center rounded-md border border-transparent bg-primary px-8 py-2 text-base font-medium text-white hover:bg-primary/80 md:py-4 md:px-10 md:text-lg'
                href='/@mosespace'
              >
